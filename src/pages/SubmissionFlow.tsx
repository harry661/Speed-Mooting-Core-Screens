                                ...
                                {currentStep === 1 && (
                                    <CardContent className="p-8 space-y-8">
                                                ...
                                                >
                                                    {isUploading ? (
                                                        <>
                                                            ...
                                                            <p className="text-sm font-medium text-gray-600 font-sans mb-2">Uploading video...</p>
                                                        </>
                                                    ) : (
                                                        <>
                                                            <Upload className="w-12 h-12 text-primary mx-auto mb-4" />
                                                            <p className="text-sm font-medium text-gray-600 font-sans mb-2">Click to browse or drag file here</p>
                                                            <p className="text-xs text-gray-400 font-sans">MP4, MOV or WEBM • Max 500MB</p>
                                                            <p className="text-xs text-gray-400 mt-1 font-sans">Recommended: 1080p, landscape orientation</p>
                                                        </>
                                                    )}
                                                </div>
                                            ) : (
                                        ...
                                        <div>
                                            ...
                                            {/* Skeleton Argument */}
                                            <div className="mb-4">
                                                <label className="text-sm font-semibold text-gray-700 font-sans mb-2 block">Skeleton Argument (Optional)</label>
                                                <input
                                                    type="file"
                                                ...
                                                {!skeletonArgument ? (
                                                    <div
                                                        ...
                                                        className="border border-dashed border-gray-200 rounded-xl p-6 hover:border-primary hover:bg-primary/5 transition-all cursor-pointer text-center"
                                                    >
                                                        <FileText className="w-8 h-8 text-gray-400 mx-auto mb-2" />
                                                        <p className="text-sm text-gray-600 font-sans">Word or PDF format</p>
                                                    </div>
                                                ) : (
                                                    <div className="border border-gray-200 rounded-xl p-4 bg-gray-50 flex items-center justify-between">
                                                        <div className="flex items-center gap-3">
                                                ...
                                                {uploadErrors.skeleton && (
                                                    <p className="text-sm text-red-600 font-sans mt-2 flex items-center gap-1">
                                                        <X className="w-4 h-4" />
                                                        {uploadErrors.skeleton}
                                                    </p>
                                                )}
                                            ...
                                            {/* Case Files */}
                                            <div>
                                                <label className="text-sm font-semibold text-gray-700 font-sans mb-2 block">Case Files (Optional)</label>
                                                <input
                                                    type="file"
                                                ...
                                                <div
                                                    ...
                                                    className="border border-dashed border-gray-200 rounded-xl p-6 hover:border-primary hover:bg-primary/5 transition-all cursor-pointer text-center mb-3"
                                                >
                                                    <File className="w-8 h-8 text-gray-400 mx-auto mb-2" />
                                                    <p className="text-sm text-gray-600 font-sans">Add legal case documents (PDF, Word)</p>
                                                </div>
                                                {caseFiles.length > 0 && (
                                        ...
                                        <div>
                                            ...
                                            <Textarea
                                                ...
                                                className="min-h-[120px] rounded-sm border-gray-200 font-sans"
                                                maxLength={500}
                                            />
                                        ...
                                        {exerciseTopics.length > 0 && (
                                            <div>
                                                <label className="text-sm font-semibold text-gray-700 font-sans mb-2 block flex items-center gap-2">
                                ...
                                {currentStep === 2 && (
                                    <CardContent className="p-8">
                                        <div className="text-center mb-8">
                                            ...
                                            <h3 className="text-2xl font-bold font-heading mb-2">Review Your Submission</h3>
                                        ...
                                        <div className="space-y-6 max-w-2xl mx-auto">
                                            ...
                                            <div className="border-b border-gray-200 pb-4">
                                                <h4 className="text-sm font-bold text-gray-400 uppercase tracking-widest font-heading mb-3">Exercise</h4>
                                            ...
                                            {/* Files Review */}
                                            <div className="border-b border-gray-200 pb-4">
                                                <h4 className="text-sm font-bold text-gray-400 uppercase tracking-widest font-heading mb-3">Uploaded Files</h4>
                                            ...
                                            {/* Description Review */}
                                            <div className="border-b border-gray-200 pb-4">
                                                <h4 className="text-sm font-bold text-gray-400 uppercase tracking-widest font-heading mb-3">Description</h4>
                                            ...
                                            {exerciseTopics.length > 0 && (
                                                <div className="border-b border-gray-200 pb-4">
                                                    <h4 className="text-sm font-bold text-gray-400 uppercase tracking-widest font-heading mb-3">Topics</h4>
                                                    <div className="flex flex-wrap gap-2">
                                                        {exerciseTopics.map((topic: string) => (
                                                            <Badge key={topic} className="px-3 py-1 bg-primary/10 text-primary border-none text-xs font-semibold font-heading">
                                                                {topic}
                                            ...
                                            {/* Terms */}
                                            <div className="bg-accent/5 border-l-4 border-accent rounded-r-xl p-4 mt-6">
