                ...
                <div className="w-full space-y-6">
                    <Card className="rounded-sm border-gray-200 bg-white shadow-none">
                        <CardContent className="p-12 text-center">
                            <h2 className="text-xl font-bold text-gray-900 font-heading mb-2">Tutorial Not Found</h2>
                            <p className="text-sm text-gray-600 font-sans mb-4">The tutorial you're looking for doesn't exist.</p>
                        ...
                        <div className="space-y-8">
                            {tutorial.content.sections.map((section, index) => (
                                <div key={index} className="space-y-4">
                                    <h2 className="text-xl font-bold text-gray-900 font-heading">{section.title}</h2>
                                    ...
                                    {section.type === "steps" && (
                                        <ol className="space-y-3 list-decimal list-inside">
                                            {(section.content as string[]).map((step, stepIndex) => (
                                                <li key={stepIndex} className="text-sm text-gray-700 font-sans leading-relaxed">
                                                    {step}
                                                </li>
                                            ))}
                                        </ol>
                                            ...
                                            <div className="flex items-start gap-3">
                                                ...
                                                <ul className="space-y-2 flex-1">
                                                    {(section.content as string[]).map((tip, tipIndex) => (
                                                        <li key={tipIndex} className="text-sm text-gray-700 font-sans leading-relaxed">
                                                            {tip}
                                                        </li>
                                                    ))}
                                                </ul>
