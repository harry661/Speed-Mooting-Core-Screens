                        ...
                        >
                            <Card className="h-full rounded-sm border-gray-200 hover:border-accent transition-colors bg-white flex flex-col group shadow-none">
                                ...
                                <CardContent className="p-5 pt-0 flex-1">
                                    <p className="text-sm text-gray-600 font-sans mb-4 leading-relaxed line-clamp-3">
                                        {ex.description}
                                    </p>
                                ...
                                <CardFooter className="p-5 pt-0">
                                    <Link to={`/exercises/${ex.id}`} className="w-full">
                                        <Button variant="outline" className="w-full border-gray-200 text-gray-700 hover:bg-accent hover:border-accent hover:text-white shadow-none rounded-sm font-heading font-bold uppercase tracking-widest text-[10px] h-11 group/btn">
                                            View Details
