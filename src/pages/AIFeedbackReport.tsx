                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div className="space-y-2">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h1 className="text-xl font-bold text-gray-900 font-heading">{submissionData.exerciseName}</h1>
                                </div>
                                <div className="flex flex-wrap items-center gap-4 text-xs text-gray-600 font-sans">
                                    ...
                                    <Badge className="text-[10px] font-heading font-semibold uppercase tracking-wider px-2 py-0.5 border bg-accent/10 text-accent border-accent/20">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <Card className="lg:col-span-2 rounded-sm border-gray-200 bg-white shadow-none">
                        <CardHeader className="border-b border-gray-100 p-5">
                            ...
                            <p className="text-xs text-gray-500 font-sans mt-1">Breakdown based on Clarity, Persuasiveness, and Structure criteria</p>
                        </CardHeader>
                                        ...
                                        <div className="flex justify-between items-end">
                                            <div className="flex-1">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    {rubric.deduction < 0 && (
                                                        <Badge variant="outline" className="text-[9px] font-bold border-red-200 text-red-700 bg-red-50 px-1.5 py-0">
                                                            {rubric.deduction} pts
                                                        </Badge>
                                                    )}
                                                </div>
                                                <p className="text-xs text-gray-500 font-sans mt-0.5">{rubric.description}</p>
                                            </div>
                ...
                {deductions.length > 0 && (
                    <Card className="rounded-sm border-gray-200 bg-white shadow-none">
                        <CardHeader 
                            ...
                            className="border-b border-gray-100 p-5 cursor-pointer hover:bg-gray-50/50 transition-colors group"
                        >
                            <div className="flex items-center justify-between w-full">
                                <div className="flex items-center gap-2">
                                    <AlertTriangle className="w-4 h-4 text-red-600" />
                                    <CardTitle className="text-base font-bold font-heading">Specific Deductions</CardTitle>
                                    <Badge variant="outline" className="text-[9px] font-bold border-red-200 text-red-700 bg-red-50 px-1.5 py-0">
                            ...
                            <p className="text-xs text-gray-500 font-sans mt-1">Point deductions with detailed explanations</p>
                        </CardHeader>
                        <AnimatePresence>
                            {isDeductionsOpen && (
                                <motion.div
                                ...
                                >
                                    ...
                                    <div 
                                        ...
                                        className={cn(
                                            ...
                                            deduction.severity === "high" && "bg-red-50 border-red-300",
                                            deduction.severity === "medium" && "bg-amber-50 border-amber-300",
                                            deduction.severity === "low" && "bg-yellow-50 border-yellow-300"
                                        )}
                                    >
                                        <div className={cn(
                                            "p-2 rounded-sm border h-fit",
                                            deduction.severity === "high" && "bg-white border-red-100 text-red-600",
                                            deduction.severity === "medium" && "bg-white border-amber-100 text-amber-600",
                                            deduction.severity === "low" && "bg-white border-yellow-100 text-yellow-600"
                                        )}>
                                        ...
                                        <div className="flex-1">
                                            <div className="flex items-center gap-3 mb-1">
                                                ...
                                                <span className="text-xs text-gray-500 font-sans">@ {deduction.timestamp}</span>
                                            </div>
                                            <p className="text-sm text-gray-800 leading-relaxed font-sans">{deduction.description}</p>
                                        </div>
                                    </div>
                                ))}
                                        </div>
                ...
                <Tabs defaultValue="insights" className="w-full">
                            ...
                            <Card className="rounded-sm border-gray-200 bg-white shadow-none">
                                ...
                                <CardContent className="p-5 space-y-3">
                                    {strengths.map((strength, index) => {
                                        ...
                                        return (
                                            <div key={index} className="p-4 bg-green-50/50 border-l-2 border-green-200 rounded-r-xl flex gap-4">
                                                <div className="bg-white p-2 rounded-sm border border-green-100 h-fit text-green-600">
                                                    <IconComponent className="w-4 h-4" />
                                                </div>
                                                <p className="text-xs text-gray-700 leading-relaxed font-sans mt-0.5">{strength.text}</p>
                                            </div>
                                        )
                                    })}
                                </CardContent>
                                    ...
                                    {suggestedImprovements.map((improvement, index) => (
                                        <div 
                                            ...
                                            className={cn(
                                                ...
                                                improvement.priority === "high" && "bg-red-50/50 border-red-200",
                                                improvement.priority === "medium" && "bg-amber-50/50 border-amber-200",
                                                improvement.priority === "low" && "bg-yellow-50/50 border-yellow-200"
                                            )}
                                        >
                                            <div className={cn(
                                                "bg-white p-2 rounded-sm border h-fit",
                                                improvement.priority === "high" && "border-red-100 text-red-600",
                                                improvement.priority === "medium" && "border-amber-100 text-amber-600",
                                                improvement.priority === "low" && "border-yellow-100 text-yellow-600"
                                            )}>
                                                <AlertTriangle className="w-4 h-4" />
                                            </div>
                                            <div className="flex-1">
                                                <div className="flex items-center gap-2 mb-1">
                                                    <h4 className="text-xs font-bold text-gray-900 font-heading">{improvement.title}</h4>
                                                    <Badge className={cn(
                                                ...
                                                <p className="text-xs text-gray-700 leading-relaxed font-sans mb-2">{improvement.description}</p>
                                                <div className="bg-white/80 p-2 rounded-sm border border-gray-200">
                                                    <p className="text-[10px] font-semibold text-gray-900 font-sans mb-1">Action:</p>
                                                    <p className="text-xs text-gray-700 leading-relaxed font-sans">{improvement.action}</p>
                                                </div>
                                                {improvement.timestamp && (
                                                    <p className="text-[10px] text-gray-500 font-sans mt-1.5">Reference: {improvement.timestamp}</p>
                                                )}
                                            </div>
                                        </div>
                                    ))}
                    ...
                    <TabsContent value="transcript" className="mt-6">
                        <Card className="rounded-sm border-gray-200 bg-white shadow-none overflow-hidden">
                            <CardHeader className="border-b border-gray-100 p-5">
                                <CardTitle className="text-base font-bold font-heading">Full Video Transcript</CardTitle>
                                <p className="text-xs text-gray-500 font-sans mt-1">Complete transcription with timestamps and AI insights</p>
                            </CardHeader>
                                    ...
                                    {transcriptData.map((item, i) => (
                                        <div 
                                            ...
                                            className={cn(
                                                ...
                                                item.issue && "bg-red-50/30 -mx-8 px-8"
                                            )}
                                        >
                                            ...
                                            <div className="flex-1">
                                                ...
                                                {item.insight && (
                                                    <div className="mt-3 inline-flex items-center gap-2 px-3 py-1.5 bg-primary text-white text-[9px] font-bold rounded-sm uppercase tracking-[0.15em]">
                                                        <Info className="w-3 h-3 text-accent" /> {item.insight}
                                                    </div>
                                                )}
                                                {item.issue && (
                                                    <div className="mt-3 inline-flex items-center gap-2 px-3 py-1.5 bg-red-100 border border-red-200 text-red-800 text-[9px] font-bold rounded-sm">
                    ...
                    <TabsContent value="accuracy" className="mt-6">
                        <Card className="rounded-sm border-gray-200 bg-white shadow-none">
                            <CardHeader className="border-b border-gray-100 p-5">
                                <CardTitle className="text-base font-bold font-heading">Accuracy & Consistency Check</CardTitle>
                                <p className="text-xs text-gray-500 font-sans mt-1">Cross-referencing with uploaded case files and skeleton arguments</p>
                            </CardHeader>
                            <CardContent className="p-5 space-y-3">
                                <div className="flex items-start gap-4 p-5 bg-red-50 rounded-r-xl border-l-4 border-red-300">
                                    <AlertTriangle className="w-5 h-5 text-red-600 mt-0.5 shrink-0" />
                                    <div className="flex-1">
                                        <h4 className="font-bold text-red-900 font-heading mb-1 text-sm">Potential Misrepresentation Detected</h4>
                                        <p className="text-xs text-red-800 font-sans mb-2 leading-relaxed">
                                ...
                                <div className="flex items-start gap-4 p-5 bg-green-50 rounded-r-xl border-l-4 border-green-300">
                                    <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5 shrink-0" />
                                    <div className="flex-1">
                                        <h4 className="font-bold text-green-900 font-heading mb-1 text-sm">Skeleton Argument Consistency</h4>
